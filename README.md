...
> **Note on Live Inference:** Live model inference and GPU cross-attention execution are locked in this public web demonstration due to compute resource allocation. All interactive discovery graphs, evidence workbenches, relationship projections, and materialized joined tables are pre-computed with synthetic benchmark data and fully navigable.
